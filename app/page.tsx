        ...
        {showForm && tab === 'empty-legs' && (
          <form onSubmit={handleVueloSubmit} style={{ backgroundColor: 'rgba(255,255,255,0.05)', border: '1px solid rgba(201,168,76,0.2)', borderRadius: 12, padding: 24, marginBottom: 32 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              ...
              <div><label style={labelStyle}>Asientos</label><input type="number" placeholder="8" value={vueloForm.asientos} onChange={e => setVueloForm({ ...vueloForm, asientos: e.target.value })} required style={inputStyle} /></div>
            </div>
          ...
          <>
            ...
            <div style={{ overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead><tr style={{ borderBottom: '1px solid rgba(201,168,76,0.2)' }}>{['Ruta', 'Fecha', 'Hora', 'Aeronave', 'Pax', 'Asiento', 'Cabina', 'Estado', 'Acciones'].map(h => <th key={h} style={{ textAlign: 'left', padding: '12px 16px', fontSize: 10, color: '#C9A84C', letterSpacing: 2 }}>{h}</th>)}</tr></thead>
                <tbody>
                  {vuelos.map(v => (
