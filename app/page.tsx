                   ...
                   <tr key={v.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                     ...
                     <td style={{ padding: '14px 16px' }}>
                       <input
                         ...
                         value={v.asientos}
                         min="0"
                         onChange={e => handleAsientosVuelo(v.id, parseInt(e.target.value))}
                         style={{ width: 60, backgroundColor: '#1B2A4A', color: v.asientos === 0 ? '#f44336' : '#4CAF50', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 6, padding: '4px 8px', fontSize: 13, textAlign: 'center' }}
                       />
                     </td>
                     ...
                     <td style={{ padding: '14px 16px' }}><button onClick={() => handleDeleteVuelo(v.id)} style={{ backgroundColor: 'rgba(244,67,54,0.1)', color: '#f44336', border: '1px solid rgba(244,67,54,0.3)', borderRadius: 6, padding: '6px 12px', cursor: 'pointer', fontSize: 12 }}>Eliminar</button></td>
                   </tr>
                 ))}
               </tbody>
             </table>
